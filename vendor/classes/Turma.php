...
class Turma
    {
        ...
        public function listAll()
        {
            ...
            {
                $sql = new Sql();
                return $sql->select("SELECT * FROM tblTurmas t inner join tblHorarios on fkHorario = idHorario where t.fkEscola = :FKESCOLA order by nomeTurma;", array(":FKESCOLA"=>$this->getFkEscola()));
            }
