      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <a href="/admin/declaracaoMatricula/<?php echo htmlspecialchars( $aluno["idAlunos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="btn btn-info">Declaração de Matrícula</a>
            <a href="" class="btn btn-info">Declaração de Frequência</a>
