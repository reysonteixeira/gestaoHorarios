      ...
      <div class="container-fluid">
        ...
        <div class="card-body row col-sm-12">
          ...
          <div class="col-sm-6 no-print">
            <form action="/admin/consolidado-aulas/<?php echo htmlspecialchars( $turma, ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="get" class="row">
        ...
        <div class="col-sm-2 no-print">
          ...
          <div class="cabecalho">
            ...
            <div class="row">
                <div class="col-5">
                    ...
                    <span><b>Tipo de Ensino: </b><?php echo htmlspecialchars( $infoTurma["txtNivelEnsino"], ENT_COMPAT, 'UTF-8', FALSE ); ?></span>
          ...
          <div class="rodape row col-12">
                ...
                <div class="col-4 line d-end">
                    
                  <p>Assinatura do Professor</p>
              </div>
        
              <div class="col-5 line d-end">
                  
                <p>Assinatura do Supervisor Pedagógico</p>
            </div>
