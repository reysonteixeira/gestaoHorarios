 ...
 <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Supervisionar - Turmas</h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
    </div>
            ...
            <table class="table mt-3">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td></td>
                  <td></td>
                  <td class="botao"><a href="/admin/supervisionarTurmas/escolas/<?php echo htmlspecialchars( $value1["fkEscola"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $value1["idTurma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button class="btn btn-primary btn-sm">Acessar <i class="fas fa-edit"></i></button></a></td>
                </tr>
