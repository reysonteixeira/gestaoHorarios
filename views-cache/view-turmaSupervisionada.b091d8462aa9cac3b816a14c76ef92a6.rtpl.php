            ...
            <div class="card card-primary">
              ...
              <form method="POST" action="/admin/turmas/<?php echo htmlspecialchars( $turma["idTurma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                ...
                <div class="card-footer col-md-12 row">
                  ...
                  <div class="col-3">
                    <a href="/admin/supervisionarTurmas/escolas/<?php echo htmlspecialchars( $escola, ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $turma["idTurma"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/professor/<?php echo htmlspecialchars( $professor, ENT_COMPAT, 'UTF-8', FALSE ); ?>/consolidadoConteudo" class="btn btn-info form-control">Consolidado de Conteúdos</a>
                  </div>
