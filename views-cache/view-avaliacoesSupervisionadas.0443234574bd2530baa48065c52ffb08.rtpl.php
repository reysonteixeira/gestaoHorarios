    ...
    <section>
      <div class="container-fluid">
        ...
        <div class="card-body row col-sm-12 d-flex align-items-end">
          ...
          <div class="col-sm-2">
            <a href="/admin/supervisionarTurmas/escolas/<?php echo htmlspecialchars( $escola, ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $turma, ENT_COMPAT, 'UTF-8', FALSE ); ?>/professor/<?php echo htmlspecialchars( $professor, ENT_COMPAT, 'UTF-8', FALSE ); ?>/notas-avaliacoes" class="btn btn-success form-control">Notas</a>
          </div>
          ...
          <table class="table mt-3">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="botao"><a href="/admin/supervisionarTurmas/escolas/<?php echo htmlspecialchars( $escola, ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $turma, ENT_COMPAT, 'UTF-8', FALSE ); ?>/professor/<?php echo htmlspecialchars( $professor, ENT_COMPAT, 'UTF-8', FALSE ); ?>/avaliacoes/<?php echo htmlspecialchars( $value1["idAvaliacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/notas"><button
                      class="btn btn-success btn-sm">Notas <i class="fas fa-check"></i></button></a></td>
                <td class="botao"><a href="/admin/supervisionarTurmas/escolas/<?php echo htmlspecialchars( $escola, ENT_COMPAT, 'UTF-8', FALSE ); ?>/turma/<?php echo htmlspecialchars( $turma, ENT_COMPAT, 'UTF-8', FALSE ); ?>/professor/<?php echo htmlspecialchars( $professor, ENT_COMPAT, 'UTF-8', FALSE ); ?>/avaliacoes/<?php echo htmlspecialchars( $value1["idAvaliacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>"><button
