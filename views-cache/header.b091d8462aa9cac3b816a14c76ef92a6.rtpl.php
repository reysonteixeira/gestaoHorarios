      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          <!-- Add icons to the links using the .nav-icon class
              ...
              <li class="nav-item">
                <a href="/admin/horarios" class="nav-link">
              ...
              <li class="nav-item">
                <a href="/admin/professores" class="nav-link">
          ...
          <?php if( $permissaoMenu < 3 ){ ?>
          <li class="nav-item">
            <a href="/admin/matriculas" class="nav-link">
          ...
          <?php if( $permissaoMenu < 3 ){ ?>
          <li class="nav-item">
            <a href="/admin/minhaEscola" class="nav-link">
              <i class="nav-icon fas fa-school"></i>
              <p>Minha escola</p>
            </a>
          </li>
          ...
          <li class="nav-item has-treeview">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="/admin/relatorio-auxilio" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Auxílios Governo</p>
                </a>
              </li>
              
              
              <li class="nav-item">
                <a href="/admin/lista-presencas" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Lista de Presença</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/alunosMatriculados" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Matrículas</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/lista-movimentacoes" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Movimentações</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="/admin/presencasDias" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Presenças por dias</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="/admin/relatorioTransporte" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
          ...
          <?php if( $permissaoMenu == 1 ){ ?>
          <li class="nav-item">
            <a href="/admin/relatorioTurmas" class="nav-link">
              <i class="nav-icon fas fa-school"></i>
