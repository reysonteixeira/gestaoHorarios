  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Editar Atividades Avaliativas</h1>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <form method="POST" action="/admin/avaliacao/<?php echo htmlspecialchars( $avaliacao["idAvaliacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                ...
                <div class="card-body row">
                  <div class="form-group col-md-3">
                    ...
                    <input type="text" class="form-control" value="<?php echo htmlspecialchars( $avaliacao["txtNomeAvaliacao"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" id="exampleInputPostagem" name="txtNomeAvaliacao">
                  </div>
                  <div class="form-group col-md-3">
                  ...
                  <div class="form-group col-md-2">
                    ...
                    <input type="date" value="<?php echo htmlspecialchars( $avaliacao["dtData"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control" id="exampleInputPostagem" name="dtDataAvaliacao">
                  </div>
                  <div class="form-group col-md-2">
                    <label for="exampleInputPostagem">Valor</label>
                    <input type="text" value="<?php echo htmlspecialchars( $avaliacao["intPontos"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" class="form-control" name="intPontos">
                  </div>

                  <div class="form-group col-md-12">
                    <label for="exampleInputDescricao">Decrição da atividade</label>
                    <textarea  class="form-control" name="txtDescricao" rows="3"><?php echo htmlspecialchars( $avaliacao["txtDescription"], ENT_COMPAT, 'UTF-8', FALSE ); ?></textarea>
                  </div>
